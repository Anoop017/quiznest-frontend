...
// Core beam/flare shaping and dynamics - EXTENDED FOR LONGER BEAM
...
#define R_H 150.0
#define R_V 300.0
#define FLARE_HEIGHT 32.0
#define FLARE_AMOUNT 6.0
#define FLARE_EXP 1.8
#define TOP_FADE_START 0.05
#define TOP_FADE_EXP 0.8
...
#define W_CURVE_AMOUNT 12.0
#define W_CURVE_RANGE (FLARE_HEIGHT - 3.0)
#define W_BOTTOM_EXP 8.0

// Volumetric fog controls - ENHANCED
#define FOG_ON 1
#define FOG_CONTRAST 1.3
#define FOG_SPEED_U 0.1
#define FOG_SPEED_V -0.1
#define FOG_OCTAVES 5
#define FOG_BOTTOM_BIAS 0.7
#define FOG_TILT_TO_MOUSE 0.05
#define FOG_TILT_DEADZONE 0.01
#define FOG_TILT_MAX_X 0.35
#define FOG_TILT_SHAPE 1.5
#define FOG_BEAM_MIN 0.0
#define FOG_BEAM_MAX 0.8
#define FOG_MASK_GAMMA 0.45
#define FOG_EXPAND_SHAPE 10.0
#define FOG_EDGE_MIX 0.6

// Horizontal vignette for the fog volume
#define HFOG_EDGE_START 0.15
#define HFOG_EDGE_END 0.98
#define HFOG_EDGE_GAMMA 1.2
#define HFOG_Y_RADIUS 40.0
#define HFOG_Y_SOFT 80.0

// Beam extents and edge masking
#define EDGE_X0 0.18
#define EDGE_X1 0.995
#define EDGE_X_GAMMA 1.1
...
#define DITHER_STRENGTH 1.0
    ...
    float span=smoothstep(-3.0,0.0,y)*(1.0-smoothstep(R_V-10.0,R_V,y));
...
void mainImage(out vec4 fc,in vec2 frag){
    ...
    browserFogIntensity *= 2.2;
    float radialFade = 1.0 - smoothstep(0.0, 0.85, length(uvc) / 180.0);
